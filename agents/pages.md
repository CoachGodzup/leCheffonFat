...
| `/page1`               | `src/app/page1/page.tsx`               | Wizard step 1 — category `<FormSelect>` via react-hook-form, stores to zustand                       |
| `/page2`               | `src/app/page2/page.tsx`               | Wizard step 2 — area `<FormSelect>` filtered by chosen category, then navigates to `/recommendation` |
